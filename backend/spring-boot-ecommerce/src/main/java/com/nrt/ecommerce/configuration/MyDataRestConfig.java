package com.nrt.ecommerce.configuration;

import com.nrt.ecommerce.entity.Product;
import com.nrt.ecommerce.entity.ProductCategory;
...
public class MyDataRestConfig implements RepositoryRestConfigurer {
    ...
    private void exposeIds(RepositoryRestConfiguration config) {
        ...
        List<Class> entityClass = new ArrayList<Class>();
